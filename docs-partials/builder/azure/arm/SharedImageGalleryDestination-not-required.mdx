...
- `replication_regions` ([]string) - Specify the replication regions for the Shared Image Gallery Image Version.

- `replication_mode` (string) - Specify the replication mode type for the Shared Image Gallery Image Version.
